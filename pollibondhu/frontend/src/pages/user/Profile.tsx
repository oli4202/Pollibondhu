          ...
          {tab === "personal" && (
            <>
              ...
              <div className="mt-7 grid gap-x-8 gap-y-6 sm:grid-cols-2">
                {[
                  ["Full name", "full_name", formData.full_name || "—"],
                  [
                    "Phone number",
                    "phone",
                  ...
                  ["District", "district", formData.district || "Add district"],
                  ["Occupation", "occupation", "Farmer"],
                  ["Land holding", "land", "Add land holding"],
                  ["Education level", "education", "Add education level"],
                  ["National ID", "nid", "Verified"],
                ].map(([label, field, value]) => (
                  <label
                    key={label as string}
                    className="text-xs font-medium text-earth-500"
                  >
                    {label}
                    {editing &&
                    ["Full name", "Phone number", "District"].includes(
                      label as string,
                    ) ? (
                      <input
                        ...
                        className="mt-2 w-full rounded-lg border border-earth-200 px-3 py-2 text-sm text-earth-800"
                      />
                    ) : (
              ...
              <div className="mt-8 rounded-xl border border-amber-200 bg-amber-50 p-4">
                <b className="text-sm">Complete your profile</b>
                <p className="mt-1 text-xs text-earth-500">
                  Add bank details and an emergency contact to receive faster
                  service.
                </p>
                <button
                  onClick={() =>
